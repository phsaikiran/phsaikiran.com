    ...
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert text-neutral-800 dark:text-neutral-200">
        <div className="flex">
          ...
          <div className="ml-auto"><em>Apr 2023 – May 2023</em></div>
        </div>
        ...
        <div className="flex">
          ...
          <div className="ml-auto"><em>Feb 2023 – May 2023</em></div>
        </div>
        ...
        <div className="flex">
          ...
          <div className="ml-auto"><em>Jan 2023 – May 2023</em></div>
        </div>
        ...
        <div className="flex">
          <a href={"https://github.com/phsaikiran/LotteryScheduler"} target="_blank" className="inline-flex items-center">
            <b className="mr-1">Lottery Scheduler for xv6 – UNIX-like OS</b>
            <ArrowIcon/>
          </a>
          <div className="ml-auto"><em>Aug 2022 – Dec 2022</em></div>
        </div>
        ...
        <div className="flex">
          ...
          <div className="ml-auto"><em>Aug 2017 – May 2019</em></div>
        </div>
        ...
        <div className="flex">
          ...
          <div className="ml-auto"><em>July 2017</em></div>
        </div>
